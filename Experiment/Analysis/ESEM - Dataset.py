"""
The purpose of this module is to assess the content of ./ESEM - Dataset.ods (look for duplicates, overlap, etc.)
"""
import os
...
# constants
ods_filepath = os.path.abspath(os.path.join(__file__,'../','ESEM - Dataset.ods'))
